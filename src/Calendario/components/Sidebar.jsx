...
import { MensageEvent } from './MensageEvent';
         ...
         <Grid container  
          ...
          sx={{
            ...
            <Grid size={{ xs: 12, md: 3 }}  sx={{ flexGrow: 'auto'}}>
                <Typography variant='h3' component='div' color='black' sx={{ p:1, display: {  md: "inline-flex" } }}>{t('Subtltle')}</Typography>
                <Typography variante='p' fontSize={20} component='small' sx={{ p:0, display: {  md: "inline-flex" } }}>{t('subTitle2')}</Typography>
                <Typography variant="h6" component='small' sx={{ p:0, display: {  md: "inline-flex" } }}>{formattedDate} </Typography>
